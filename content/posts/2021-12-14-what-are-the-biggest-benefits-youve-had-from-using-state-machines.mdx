...
Pat’s blog post goes into fascinating depth on his work with Crucible. And the section on XState goes from realizing that he needed a state machine to moving much of their application logic into statecharts.
...
**[Joshua**@josmithua](https://twitter.com/josmithua)
