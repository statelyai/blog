...
Unlike [descriptions](https://stately.ai/docs/descriptions), which are tied to specific states or transitions, annotations are notes you can use to annotate your machine, positioned anywhere inside your machine. To add an annotation, right-click anywhere on the canvas to bring up the canvas menu and use **Add annotation** to add your annotation.
