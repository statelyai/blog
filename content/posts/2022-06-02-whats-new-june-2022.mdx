...
[Watch Matt demonstrate the power of model-based testing with XState Test in a short video on Twitter](https://twitter.com/statelyai/status/1531250605313892352):
...
- [Read the XState test tag release notes on GitHub](https://github.com/statelyai/xstate/releases/tag/%40xstate%2Ftest%401.0.0-alpha.0).
