...
And yes, it goes both ways: edit the code and see the updated state diagram. Edit the state diagram and see the updated code in real-time with the [XState VS Code extension](https://marketplace.visualstudio.com/items?itemName=mattpocock.xstate-vscode&ssr=false)

## What are state machines?

State machines (also known as state diagrams) are visual formalisms that represent the state of something, and how that state can change over time. This is a great way to represent application logic, since they're visually exact, like code, and can be used for both planning, design, development, and testing. To learn more, check out the [introduction to state machines and statecharts](https://xstate.js.org/docs/guides/introduction-to-state-machines-and-statecharts/).

[XState](https://github.com/statelyai/xstate) is a library for building state machines and statecharts in code. The [Stately Viz](https://stately.ai/viz) visualizes state machines created with XState, and can even inspect them running in applications. And now, you can create those same state diagrams visually with the Stately Editor.

## Editor overview

To get started, go to [stately.ai/editor](https://stately.ai/editor?source=blog). From there, you can begin creating your state diagrams in the editor.
