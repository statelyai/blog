...
**Try the Stately Editor beta now at [stately.ai/editor](https://stately.ai/editor)**

![Visualize your application logic with the Stately Editor](./images/2022-2-6-editor.png)
...
And yes, it goes both ways: edit the code and see the updated state diagram. Edit the state diagram and see the updated code in real-time. All this is possible with the [XState VS Code extension](https://marketplace.visualstudio.com/items?itemName=mattpocock.xstate-vscode&ssr=false).
...
<Announcement cta="Sign up here">
  Sign up to the Stately editor beta and start modeling your app logic visually.
</Announcement>
