...
And yes, it goes both ways: edit the code and see the updated state diagram. Edit the state diagram and see the updated code. All in real-time.

## Editor overview

To get started, go to [stately.ai/editor](https://stately.ai/editor). From there, you can begin creating your state diagrams in the editor. Watch the video below to find out more:
