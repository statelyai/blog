---
title: "Introducing: Perfect TypeScript types for XState"
...
We have brought type generation into XState v4.29.0, meaning you can get **perfect types on all parts of XState's API**.
