...
As with any major version, there are some breaking changes. We’ve tried to keep these to a minimum, but some of them are necessary to make XState v5 beta as powerful and flexible as possible. Here is the current guide for migrating from XState v4 to v5 and the list of breaking changes: https://stately.ai/docs/xstate-v5/migration
...
Speaking of Stately Studio, besides adding support for XState v5, we’re taking the "everything is an actor" support to heart and will be building visual tooling for not only managing actor logic, but also entire actor systems and the communication between actors. This will be a huge step forward for visualizing and debugging complex systems, and we’re excited to share more about this in the future.
