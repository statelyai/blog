...
> “I did a demo of the visualizer in front of devs and non-devs (ux designers and managers). They like the fact it gives the opportunity to discuss about features before jumping into coding”
[Seya Obey’s tweet](https://twitter.com/seya_obey/status/1446237663535714304).

> “I did a presentation showing the amazing power of xstate. Visualizer, Examples, Inspect for debugging and generate testing.”
[yanir manor’s tweet](https://twitter.com/ManorYanir/status/1446087845073113092).

## Give examples using their own work

Nick Hehr takes it step-by-step, utilizing the Visualizer.

> “I start by demonstrating how visualizing a feature as a statechart can help understand the problem. Only once they’re on board with that premise would I start pointing to xstate for developing that statechart.”
[Nick Hehr’s tweet](https://twitter.com/hipsterbrown/status/1446092594338017280).

> “Take a part of the app they modeled, find out the bugs and solve them by remodeling it using a statechart. Then show them the visualization.”
[Farzad Yousefzadeh’s tweet](https://twitter.com/farzad_yz/status/1446062078264020994).
...
> “Make a short experiment and compare with other tools (e.g. implement a feature in Xstate and Redux and see by yourself)”
[Amy Pellegrini’s tweet](https://twitter.com/amyvpellegrini/status/1446419479483793411).

> “Use the visualizer to model your system beforehand. Using state-machine tool will be a natural progression from that.”
[Amy Pellegrini’s second tweet](https://twitter.com/amyvpellegrini/status/1446419828185645058).
